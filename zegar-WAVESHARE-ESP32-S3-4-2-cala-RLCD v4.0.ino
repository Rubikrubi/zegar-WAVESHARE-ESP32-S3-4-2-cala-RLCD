...
//  Zegar NTP v4.0 — finalna wersja produkcyjna
...
//
//  Hardening v4.0 (przelaczniki ENABLE_* ponizej): watchdog zadania z obsluga
...
#include "esp_sntp.h"
#include "esp_task_wdt.h"   // watchdog zadania (TWDT) — hardening v4.0
#include "esp_system.h"     // esp_reset_reason() — diagnostyka v4.0
...
#define FW_VERSION     "4.0"          // finalna wersja produkcyjna
