...
constexpr int      NTP_HOUR                   = 10;  // codzienna synchronizacja 10:00-10:05 (+ dogonienie do 23:00)
...
static void checkNtpSchedule() {
  ...
  int day = localDayKey(t);
  // Preferowane okno 10:00-10:05; pominiete (np. dlugi upload) -> dogon o dowolnej
...
void setup() {
  ...
  // o 06:00 (drugie dobowe synchro obok 10:00). Po zwyklym wybudzeniu wystarcza RTC.
