...
static bool serviceNtp() {
  ...
  if (g_ntpGotPacket.load(std::memory_order_acquire)) {
    ...
    // (>=18:00, przed noca). Inaczej poranny sync o 06:00 (lub manualny/zimny start
    // przed poludniem) skonsumowalby ntpStartedDay i ZABLOKOWAL synchronizacje 18:00.
    // Poranne 06:00 ma wlasny, niezalezny znacznik ntpMorningDay.
